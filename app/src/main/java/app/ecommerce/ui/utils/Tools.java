...
import app.ecommerce.ui.BuildConfig;
import app.ecommerce.ui.R;
import app.ecommerce.ui.activity.ActivityWebView;
import app.ecommerce.ui.activity.MainMenu;
import app.ecommerce.ui.data.SharedPref;
    ...
    public static void showDialogAbout(final Activity act) {
        ...
        ((View) dialog.findViewById(R.id.bt_getcode)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Tools.openInAppBrowser(act, "https://codecanyon.net/user/dream_space/portfolio", false);
            }
        });
