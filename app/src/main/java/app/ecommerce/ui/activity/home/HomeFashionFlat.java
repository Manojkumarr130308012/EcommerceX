...
public class HomeFashionFlat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_fashion_flat);
        initToolbar();
        initComponent();
    }
    ...
    private void addBottomDots(LinearLayout layout_dots, int size, int current) {
        ...
        if (dots.length > 0) {
            dots[current].setColorFilter(ContextCompat.getColor(this, R.color.grey_60), PorterDuff.Mode.SRC_ATOP);
        }
    }
    ...
    private static class AdapterImageSlider extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View v = inflater.inflate(R.layout.item_slider_image_only, container, false);
