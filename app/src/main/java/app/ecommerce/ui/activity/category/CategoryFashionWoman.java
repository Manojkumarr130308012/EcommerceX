...
public class CategoryFashionWoman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_fashion_woman);
    ...
    private void initToolbar() {
        ...
        Tools.setSystemBarColor(this, R.color.greytoolbar);
    }
    ...
    private void addBottomDots(LinearLayout layout_dots, int size, int current) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setColorFilter(ContextCompat.getColor(this, R.color.overlay_dark_20), PorterDuff.Mode.SRC_ATOP);
    ...
    private static class AdapterImageSlider extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View v = inflater.inflate(R.layout.item_slider_image_woman, container, false);
