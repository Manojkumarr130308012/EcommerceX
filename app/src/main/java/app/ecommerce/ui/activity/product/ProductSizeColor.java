...
public class ProductSizeColor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_size_color);
        initToolbar();
        initComponent();
    }
    ...
    private void addBottomDots(LinearLayout layout_dots, int size, int current) {
        ...
        if (dots.length > 0) {
            dots[current].setColorFilter(ContextCompat.getColor(this, R.color.deep_orange_500), PorterDuff.Mode.SRC_ATOP);
        }
    }
